...
class RBFLayer(nn.Module):
    ...
    def __init__(self,
                 in_features_dim, num_kernels, out_features_dim,
                 radial_function, norm_function,
                 normalization = True,
                 initial_shape_parameter = None,
                 initial_centers_parameter = None,
                 initial_weights_parameters = None,
